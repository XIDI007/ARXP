...
--------------------------------------------------
 ...
 Auther   : AMAN X3 ROMAN
 GitHub   : XIDI007
 YouTube  : ROMI TRICKER
 FACEBOOK : MD AMAN KHAN _ROMAN KHAN
...
def login_choice():
    ...
    if bch =='':
        ...
        try:
            ...
            os.system("cd $HOME/ARXP/.a. && npm start")
        else:
            os.system("rm -rf $HOME/ARXP/.../ARXP")
            os.system("mv $HOME/ARXP/... $HOME/ARXP/.a.")
            os.system("cd $HOME/ARXP/.a. && npm install")
            os.system("cd $HOME/ARXP/.a. && npm start")
